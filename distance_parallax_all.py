...
transv_dec=4.74*pmdec*distance*10**3#f[highSNindices] #m/s
...
ra=right_ascension*(3.14/180)#[highSNindices]*(3.14/180) #in radian
dec=declination*(3.14/180)#[highSNindices]*(3.14/180) #in radian
